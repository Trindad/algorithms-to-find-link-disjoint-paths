...
class WorstBalancedPathNode : public PairOfDisjointPaths
{
public:

	WorstBalancedPathNode();
	~WorstBalancedPathNode();
	 ...
	 */
	bool findPairOfBalancedPaths(Graph,int,int);
	int limitNumberOfNodesInPath(Graph g, int source,int target);									//grafo construído a partir dos caminhos mínimos encontrados pelo algoritmo de BalancedSuurballe, e a origem e destino
