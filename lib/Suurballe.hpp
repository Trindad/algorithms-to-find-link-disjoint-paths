...
public:
	 ...
	 */
	vector< vector<int> > findPairOfBalancedPaths(Graph,int,int);		//grafo construído a partir dos caminhos mínimos encontrados pelo algoritmo de Suurballe, e a origem e destino
